...
def main():
    ...
    con.execute("""
        CREATE OR REPLACE TABLE ethusd_training_1h_v5 AS
        WITH joined AS (
            SELECT
                e.open_time,
                e.close_time,
            ...
            SELECT
                *,
                CASE
                    ...
                    WHEN regime_label = 'high_volatility' AND rel_volume_24 >= 0.8 THEN 1
                    WHEN regime_label = 'range' AND ABS(sma_7_vs_24) >= 0.003 THEN 1
                    WHEN regime_label = 'compression' AND rel_volume_24 >= 1.2 THEN 1
                    ELSE 0
                ...
                CASE
                    ...
                    WHEN regime_label = 'range' AND event_label = 1 THEN 'medium'
                    WHEN regime_label = 'compression' AND event_label = 1 THEN 'low'
                    ELSE 'low'
    ...
    print("Training table summary v2:")
